...
//    public function insertUser($fullname, $status){
//        try{
//            $query = "INSERT INTO tutorial.account (name, status) VALUES (:name, :status)";
...
//        $query = "INSERT INTO tutorial.accountdetails (account_id, address, gender) VALUES ('$this->account_id', '$this->address', '$this->gender')";
        try{
